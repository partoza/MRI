...
export default function PurposeSection() {
	...
	const purposeLeftDesk = useTransform(
		smoothProgress,
		[0, 0.2],
		["0%", "33.333%"],
	);
	const purposeWidthDesk = useTransform(
		smoothProgress,
		[0, 0.2],
		["50%", "33.333%"],
	);
	const purposeHeightDesk = useTransform(
		smoothProgress,
		[0, 0.2],
		["80vh", "60vh"],
	);
	const purposeTopDesk = useTransform(
		smoothProgress,
		[0, 0.2],
		["10vh", "20vh"],
	);
	...
	const purposeTopMob = useTransform(
		smoothProgress,
		[0, 0.2],
		["0%", "33.333%"],
	);
	const purposeHeightMob = useTransform(
		smoothProgress,
		[0, 0.2],
		["100%", "33.333%"],
	);
	const purposeWidthMob = useTransform(
		smoothProgress,
		[0, 0.2],
		["100%", "100%"],
	);
		...
		>
			...
			<div
				style={{
					...
					background:
						"linear-gradient(to bottom, transparent 0%, var(--bg) 15%, var(--bg) 100%)",
				...
				>
					...
					>
						<div className="card-bg">
							...
							<div
								...
								style={{
									background:
										"linear-gradient(to bottom, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.1) 70%, transparent 100%)",
								}}
							/>
						...
						<div className="card-text">
							...
							<p>
								Forging global partnerships to
								<br />
								place world-class solutions
								<br />
								within reach.
							</p>
						</div>
					...
					>
						<div className="card-bg">
							...
							<div
								...
								style={{
									background:
										"radial-gradient(circle, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.1) 100%)",
								}}
							/>
							<div className="card-shadow" />
						</div>
					...
					>
						...
						<div className="card-text">
							...
							<p>
								To become a Top 10 global
								<br />
								Filipino company, reaching 4<br />
								billion people across 195
								<br />
								countries.
							</p>
						</div>
